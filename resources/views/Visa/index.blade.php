...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                {{ $list['search'] }}
                <a href="{{route('visas.create')}}" style="float:right;" class="my-2 btn btn-info">Create Visa</a>
                <div class="my-2">
                @component('components.table',['class'=> 'lf-data-table'])
                    @slot('thead')
                        <tr class="bg-primary text-white">
                            ...
                            <th class="min-phone-l">{{ __('Visa Duration') }}</th>
                            ...
                            <td class="lf-action text-right">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                                        <a class="dropdown-item" href="{{ route('visas.show',$data->id)}}"><i
                                                class="fa fa-eye"></i> {{ __('Show') }}</a>
                                        <a class="dropdown-item" href="{{ route('visas.edit',$data->id)}}"><i
                                        ...
                                        <a class="dropdown-item confirmation"
                                           ...
                                           href="{{ route('visas.destroy',$data->id) }}"><i
