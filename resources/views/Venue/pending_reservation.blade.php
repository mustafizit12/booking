                ...
                @component('components.table',['class'=> 'lf-data-table'])
                    @slot('thead')
                        <tr class="bg-primary text-white">
                            ...
                            <th class="all">{{ __('From Date') }}</th>
                            <th class="all">{{ __('To Date') }}</th>
                            ...
                            <td class="lf-action text-right">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                                        ...
                                        <a class="dropdown-item" href="{{url('reservation_approved/'.$data->id.'/venue')}}">Approved</a>
                                        <a class="dropdown-item confirmation" href="{{url('reservation_reject/'.$data->id.'/venue')}}">Rejected</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
