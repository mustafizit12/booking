        ...
        <div class="row">
            <div class="offset-1 col-md-10">
                <div class="bg-primary text-white clearfix py-3 px-3 mb-3">
                    <h5 class="float-left">{{ __('Create New Slider') }}</h5>
                ...
                {{ Form::open(['route'=>'sliders.store', 'method' => 'post', 'class'=>'form-horizontal user-form','files'=> true]) }}
                @basekey
                  ...
                  <div class="form-group mb-1">
                      ...
                      <div>
                          {{ Form::text(fake_field('title'),  old('title', null), ['class'=>form_validation($errors, 'title'), 'id' => fake_field('title'),'data-cval-name' => 'The Title field','data-cval-rules' => 'required']) }}
