                            ...
                            <td class="lf-action text-right">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                                        ...
                                        <a class="dropdown-item" href="{{url('reservation_approved/'.$data->id.'/tour_package')}}">Approved</a>
                                        <a class="dropdown-item confirmation" href="{{url('reservation_reject/'.$data->id.'/tour_package')}}">Rejected</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
