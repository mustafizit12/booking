                ...
                @component('components.table',['class'=> 'lf-data-table'])
                    ...
                    @foreach($list['items'] as $key=>$data)
                        <tr>
                            ...
                            <td>{{$data->rentCar->car_model}}</td>
                            <td>{{ $data->rentCar->owner_name }}</td>
                            <td>{{$data->rentCar->owner_contact}}</td>
                            ...
                            <td class="lf-action text-right">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                                        ...
                                        <a class="dropdown-item" href="{{url('reservation_approved/'.$data->id.'/rent_car')}}">Approved</a>
                                        <a class="dropdown-item confirmation" href="{{url('reservation_reject/'.$data->id.'/rent_car')}}">Rejected</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
