...
class SystemNoticeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('core.system_notice.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('core.system_notice.create', $data);
    }
    ...
    {
        $noticeInput = $request->only(['title', 'description', 'start_at', 'end_at', 'is_active', 'type']);
    ...
    public function edit($id)
    {
        ...
        return view('core.system_notice.edit', $data);
    }
    ...
    {
        $systemNotice = $request->only(['title', 'description', 'start_at', 'end_at', 'is_active', 'type']);

        if ($this->systemNotice->update($systemNotice, $id)) {
            return redirect($this->getRedirectUri())->with(SERVICE_RESPONSE_SUCCESS, __('System notice has been updated successfully.'));
        }
    ...
    public function destroy($id)
    {
        if ( $this->systemNotice->deleteById($id) ) {
            ...
            return back()->with(SERVICE_RESPONSE_SUCCESS, __('System notice has been deleted successfully.'));
        }
