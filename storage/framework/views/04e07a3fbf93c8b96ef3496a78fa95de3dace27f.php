    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="<?php echo e(route('rooms.create')); ?>" style="float:right;" class="my-2 btn btn-info">Create Room</a>
                <div class="my-2">
                <?php $__env->startComponent('components.table',['class'=> 'lf-data-table']); ?>
                    <?php $__env->slot('thead'); ?>
                        <tr class="bg-primary text-white">
                            <th class="all"><?php echo e(__('Hotel')); ?></th>
                            <th class="all"><?php echo e(__('Room Name')); ?></th>
                            <th class="all"><?php echo e(__('Room Adult Rent')); ?></th>
                    ...
                    <?php $__currentLoopData = $list['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($data->hotel->name); ?></td>
                            <td><?php echo e($data->room_name); ?></td>
                            <td><?php echo e($data->room_rent_adult); ?></td>
                            ...
                            <td class="lf-action text-right">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                                        <a class="dropdown-item" href="<?php echo e(route('rooms.show',$data->id)); ?>"><i
                                                class="fa fa-eye"></i> <?php echo e(__('Show')); ?></a>
                                        <a class="dropdown-item" href="<?php echo e(route('rooms.edit',$data->id)); ?>"><i
                                        ...
                                        <a class="dropdown-item confirmation"
                                           ...
                                           href="<?php echo e(route('rooms.destroy',$data->id)); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/booking/resources/views/Room/index.blade.php ENDPATH**/ ?>