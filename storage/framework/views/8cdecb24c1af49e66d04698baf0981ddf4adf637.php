    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="<?php echo e(route('areas.create')); ?>" style="float:right;" class="my-2 btn btn-info">Create Area</a>
                <div class="my-2">
                <?php $__env->startComponent('components.table',['class'=> 'lf-data-table']); ?>
                    <?php $__env->slot('thead'); ?>
                        <tr class="bg-primary text-white">
                            <th class="all"><?php echo e(__('Area Name')); ?></th>
                            <th class="min-phone-l"><?php echo e(__('Details')); ?></th>
                            ...
                            <td class="lf-action text-right">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                                        <a class="dropdown-item" href="<?php echo e(route('areas.show',$data->id)); ?>"><i
                                                class="fa fa-eye"></i> <?php echo e(__('Show')); ?></a>
                                        <a class="dropdown-item" href="<?php echo e(route('areas.edit',$data->id)); ?>"><i
                                        ...
                                        <a class="dropdown-item confirmation"
                                           ...
                                           href="<?php echo e(route('areas.destroy',$data->id)); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/booking/resources/views/Area/index.blade.php ENDPATH**/ ?>