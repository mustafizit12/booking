    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="<?php echo e(route('rentCars.create')); ?>" style="float:right;" class="my-2 btn btn-info">Create Rent Car</a>
                <div class="my-2">
                <?php $__env->startComponent('components.table',['class'=> 'lf-data-table']); ?>
                    <?php $__env->slot('thead'); ?>
                        <tr class="bg-primary text-white">
                            <th class="all"><?php echo e(__('Owner Name')); ?></th>
                            <th class="all"><?php echo e(__('Car Model')); ?></th>
                            <th class="all"><?php echo e(__('Owner Contact')); ?></th>
                    ...
                    <?php $__currentLoopData = $list['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($data->car_model); ?></td>
                            <td><?php echo e($data->owner_contact); ?></td>
                            <td class="lf-action text-right">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                                        <a class="dropdown-item" href="<?php echo e(route('rentCars.show',$data->id)); ?>"><i
                                                class="fa fa-eye"></i> <?php echo e(__('Show')); ?></a>
                                        <a class="dropdown-item" href="<?php echo e(route('rentCars.edit',$data->id)); ?>"><i
                                        ...
                                        <a class="dropdown-item confirmation"
                                           ...
                                           href="<?php echo e(route('rentCars.destroy',$data->id)); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/booking/resources/views/RentCar/index.blade.php ENDPATH**/ ?>