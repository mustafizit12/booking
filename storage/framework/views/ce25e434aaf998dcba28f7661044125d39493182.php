      ...
      <!--three-fourth content-->
        <section class="three-fourth">
          ...
          <div class="deals clearfix">
            <?php if(isset($search_hotel) && !empty($search_hotel)): ?>
            <?php
            $image = App\Models\Admin\HotelImage::where('hotel_id',$search_hotel->id)->get();
            ?>
            <!--deal-->
            <article class="one-fourth">
              <figure><a href="<?php echo e(url('hotel_details/'.$search_hotel->id)); ?>" title="">
                <img src="<?php if(sizeof($image)>0): ?><?php echo e(get_hotel_image($image[0]->image_path)); ?><?php endif; ?>" alt="" width="270" height="152" /></a></figure>
              <div class="details">
                <h1><?php echo e($search_hotel->name); ?>

                  <span class="stars">
                    <?php if($search_hotel->hotel_category >0): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                    <?php if($search_hotel->hotel_category >1): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                    <?php if($search_hotel->hotel_category >2): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                    <?php if($search_hotel->hotel_category >3): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                    <?php if($search_hotel->hotel_category >4): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                  </span>
                </h1>
                <span class="address"><?php echo e($search_hotel->area_name); ?></span>
                <?php if(Session::has('total_days') && Session::get('total_days') != 0): ?>
                <span class="price"><?php echo e(Session::get('total_days')); ?> Nights <?php echo e(Session::get('adult')); ?> Adult  <em>BDT <?php echo e(Session::get('total_days') * $search_hotel->min_room_cost); ?></em> </span>
                <?php else: ?>
                <span class="price">Price per room per night from  <em><?php echo e($search_hotel->min_room_cost); ?></em> </span>
                <?php endif; ?>
                <div class="description">
                  <?php if(strlen($search_hotel->description)>200): ?>
                  <p><?php echo substr($search_hotel->description, 0, 200); ?> <a href="<?php echo e(url('hotel_details/'.$search_hotel->id)); ?>">More info</a></p>
                  <?php else: ?>
                  <p><?php echo $search_hotel->description; ?> </p>
                  <?php endif; ?>
                </div>
                <a href="<?php echo e(url('hotel_details/'.$search_hotel->id)); ?>" title="Book now" class="gradient-button">Book now</a>
              </div>
            </article>
            <!--//deal-->
            ...
            <!--deal-->
            <article class="one-fourth">
              <figure><a href="<?php echo e(url('hotel_details/'.$value->id)); ?>" title="">
                <img src="<?php if(sizeof($image)>0): ?><?php echo e(get_hotel_image($image[0]->image_path)); ?><?php endif; ?>" alt="" width="270" height="152" /></a></figure>
              <div class="details">
                <h1><?php echo e($value->name); ?>

                  <span class="stars">
                    <?php if($value->hotel_category >0): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                    <?php if($value->hotel_category >1): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                    <?php if($value->hotel_category >2): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                    <?php if($value->hotel_category >3): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                    <?php if($value->hotel_category >4): ?>
                    <img src="<?php echo e(asset('frontend/images/ico/star.png')); ?>" alt="" />
                    <?php endif; ?>
                  </span>
                </h1>
                <span class="address"><?php echo e($value->area_name); ?></span>
                <?php if(Session::has('total_days') && Session::get('total_days') != 0): ?>
                <span class="price"><?php echo e(Session::get('total_days')); ?> Nights <?php echo e(Session::get('adult')); ?> Adult <?php if(Session::get('child')): ?> <?php echo e(Session::get('child')); ?> Child <?php endif; ?>  <em>BDT <?php echo e(Session::get('total_days') * $value->min_room_cost); ?></em> </span>
                <?php else: ?>
                <span class="price">Price per room per night from  <em><?php echo e($value->min_room_cost); ?></em> </span>
                <?php endif; ?>
                <div class="description">
                  <?php if(strlen($value->description)>200): ?>
                  <p><?php echo substr($value->description, 0, 200); ?> <a href="<?php echo e(url('hotel_details/'.$value->id)); ?>">More info</a></p>
                  <?php else: ?>
                  <p><?php echo $value->description; ?> </p>
                  <?php endif; ?>
                </div>
                <a href="<?php echo e(url('hotel_details/'.$value->id)); ?>" title="Book now" class="gradient-button">Book now</a>
              </div>
            </article>
            <!--//deal-->
...
<?php echo $__env->make('fontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/booking/resources/views/fontend/hotel_list.blade.php ENDPATH**/ ?>